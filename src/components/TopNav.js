...
const TopNav = () => {
  ...
  return (
    <div className="max-w-[1520px] mx-auto flex justify-between items-center p-2">
      <div className="flex items-center">
        <div className="cursor-pointer" onClick={() => setSideNav(!sideNav)}>
          <AiOutlineMenu size={25} />
        </div>
        <h1 className="text-2xl sm:text-3xl lg:text-4xl px-2">
          <span>Yum</span> <span className="font-bold">Eats</span>
        </h1>
      ...
      >
        <AiOutlineClose
          onClick={() => setSideNav(!sideNav)}
          size={25}
          className="absolute right-4 cursor-pointer top-5"
        />
